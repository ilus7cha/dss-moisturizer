...
<form id="form" method="POST" action="./proses/prosesubah.php">
    ...
    <div class="panel-middle">
        <div class="group-input">
            ...
            <input type="text" value="<?php echo $data['namaKriteria']; ?>" class="form-custom" required autocomplete="off" placeholder="Masukkan nama kriteria" id="kriteria" name="kriteria">
        </div>
        <div class="group-input">
